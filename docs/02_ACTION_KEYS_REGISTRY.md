# 02 — ACTION KEYS REGISTRY (auto-export)

Источник истины: `src/bot/actionRegistry.js`.

- Всего action keys: **458**
- По типам: **ADMIN**=43, **EDIT**=330, **OPS**=74, **PAY**=11
- По guard: **NONE**=120, **REQUIRE_REDIS**=338

> Guard `require_redis` = fail-closed при деградации Redis (кроме break-glass allowlist для супер‑админа).

| action key | type | guard | break-glass |
|---|---|---|---|
...
| `a:brand_app_accept` | `edit` | `require_redis` |  |
