...
| Action | Type | Guard |
|---|---|---|
| `a:acc_del_do` | ops | db_truth |
| `a:acc_del_q` | ops | none |
| `a:acc_restore` | ops | db_truth |
...
| `a:adm_support_reply_cancel` | admin | none |
...
| `a:admin_ops_pending_clear` | admin | none |
| `a:admin_ops_pending_clear_do` | admin | none |
...
| `a:aw_auth_dec` | admin | require_redis |
