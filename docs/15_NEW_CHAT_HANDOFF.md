...
- Contacts / Brand Pass: structured contacts (`profile_contacts` JSONB) + opt-in UI для креатора + приоритет structured→legacy + unlock DB-truth (см. `docs/20_CONTACTS_MODEL.md`)
