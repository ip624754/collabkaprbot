...
20) Текущий handoff-safe baseline: **STEP586G** (admin/operator vocabulary on top of STEP586F). Следующий scoped STEP: **STEP586H — Live Telegram Acceptance and Mobile Copy Pass**. Перед новой работой сверяй `docs/00_CURRENT_STATE.md`, `docs/00_BOOT.md`, `docs/15_NEW_CHAT_HANDOFF.md` и `docs/92_PROD_ENV_BASELINE.md`.
