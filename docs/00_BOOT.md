...
20) Текущий handoff-safe baseline: **STEP580** (docs/governance layer on top of STEP579 runtime baseline). Перед новой работой сверяй `docs/00_CURRENT_STATE.md`, `docs/00_BOOT.md`, `docs/15_NEW_CHAT_HANDOFF.md` и `docs/92_PROD_ENV_BASELINE.md`.
