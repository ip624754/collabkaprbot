...
20) Текущий handoff-safe baseline: **STEP586B** (Home/Menu/role navigation contract on top of STEP586A). Следующий scoped STEP: **STEP586C — Applications, Dialogs and Deals Lifecycle**. Перед новой работой сверяй `docs/00_CURRENT_STATE.md`, `docs/00_BOOT.md`, `docs/15_NEW_CHAT_HANDOFF.md` и `docs/92_PROD_ENV_BASELINE.md`.
