...
assert.ok(gwAccessRouteSource.includes('await renderGwAccess({ ctx, gwId, ownerUserId, redis, db, forceRecheck: false });'), 'gw_access route must preserve access render entry');
