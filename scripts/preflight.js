...
const SOURCE_NPM_CHECKS = [
  ...
  ["Preflight (source-only): Neon cron connection resilience and alert truth", "smoke:neon-cron-resilience-contract"],
  ...
  ["Preflight (source-only): admin web users mobile working-slice contract", "smoke:admin-web-users-mobile-contract"],
  ["Preflight (source-only): admin web sidebar nav contract", "smoke:admin-web-sidebar-nav-contract"],
  ...
  ["Preflight (source-only): health/privacy/readiness critical executable tests", "test:health-privacy-readiness-critical"],
  ["Preflight (source-only): health/logging privacy/readiness source contract", "smoke:health-privacy-readiness-contract"],
  ["Preflight (source-only): admin web runtime stale-retry truth contract", "smoke:admin-web-runtime-stale-retry-contract"],
  ["Preflight (source-only): QStash fanout gate truth contract", "smoke:qstash-fanout-gate-contract"],
  ...
  ["Preflight (source-only): admin web density / interaction contract", "smoke:admin-web-density-interaction-contract"],
  ["Preflight (source-only): admin web login contract", "smoke:admin-web-login-contract"],
  ["Preflight (source-only): admin web auth critical executable tests", "test:admin-web-auth-critical"],
  ["Preflight (source-only): admin web auth browser-binding contract", "smoke:admin-web-auth-binding-contract"],
  ...
  ["Preflight (source-only): admin web overview/runtime truth contract", "smoke:admin-web-overview-runtime-truth-contract"],
  ["Preflight (source-only): admin web layout polish contract", "smoke:admin-web-layout-polish-contract"],
  ["Preflight (source-only): backoffice productization architecture contract", "smoke:backoffice-productization-contract"],
  ...
  ["Preflight (source-only): admin/auth bounded-domain executable tests", "test:admin-auth-domain-extraction"],
  ["Preflight (source-only): admin/auth bounded-domain source contract", "smoke:admin-auth-domain-extraction-contract"],
  ["Preflight (source-only): payment bounded-domain executable tests", "test:payment-domain-extraction"],
  ["Preflight (source-only): payment bounded-domain source contract", "smoke:payment-domain-extraction-contract"],
  ["Preflight (source-only): giveaway bounded-domain executable tests", "test:giveaway-domain-extraction"],
  ["Preflight (source-only): giveaway bounded-domain source contract", "smoke:giveaway-domain-extraction-contract"],
  ["Preflight (source-only): broadcast bounded-domain executable tests", "test:broadcast-domain-extraction"],
  ...
  ["Preflight (source-only): workspace control/folders bounded-domain executable tests", "test:workspaces-control-folders-domain-extraction"],
  ["Preflight (source-only): workspace control/folders bounded-domain source contract", "smoke:workspaces-control-folders-domain-extraction-contract"],
  ["Preflight (source-only): workspace profile/social bounded-domain executable tests", "test:workspaces-profile-social-domain-extraction"],
  ...
  ["Preflight (source-only): brand team/manager bounded-domain executable tests", "test:brand-team-manager-domain-extraction"],
  ...
  ["Preflight (source-only): admin users/support/moderator governance bounded-domain executable tests", "test:admin-users-support-moderator-governance-domain-extraction"],
  ...
  ["Preflight (source-only): monetization/official publish worker decomposition", "test:qstash-monetization-official-publish-worker-decomposition"],
  ["Preflight (source-only): monetization/official publish compatibility handlers", "smoke:qstash-monetization-official-publish-compatibility-handlers-contract"],
  ["Preflight (source-only): monetization/official publish real ESM linkage", "smoke:qstash-monetization-official-publish-esm-linkage-contract"],
  ["Preflight (source-only): admin-web client decomposition", "test:admin-web-client-decomposition"],
  ["Preflight (source-only): admin-web compatibility entry", "smoke:admin-web-client-compatibility-entry-contract"],
  ["Preflight (source-only): admin-web real ESM linkage", "smoke:admin-web-client-esm-linkage-contract"],
  ...
  ["Preflight (source-only): STEP592 founding cohort model", "test:step592-founding-cohort"],
  ["Preflight (source-only): STEP592 founding cohort source contract", "smoke:step592-founding-cohort-contract"],
  ["Preflight (source-only): STEP592 founding cohort ESM linkage", "smoke:step592-founding-cohort-esm-linkage-contract"],
  ["Preflight (source-only): STEP592 launch readiness contract", "check:step592-launch-readiness"],
  ...
  ["Preflight (source-only): broadcast delivery unknown-state executable tests", "test:broadcast-delivery-unknown-critical"],
  ["Preflight (source-only): broadcast delivery unknown-state contract", "smoke:broadcast-delivery-unknown-state-contract"],
