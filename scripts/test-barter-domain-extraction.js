...
equal(summary.extracted, 433, 'STEP590E5C cumulative extracted ownership total');
equal(summary.legacy, summary.total - 433, 'STEP590E5C cumulative legacy ownership total');
