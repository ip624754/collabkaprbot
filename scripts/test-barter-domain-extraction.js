...
equal(summary.extracted, 464, 'STEP590E5D cumulative extracted ownership total');
equal(summary.legacy, summary.total - 464, 'STEP590E5D cumulative legacy ownership total');
