...
equal(summary.extracted, 323, 'STEP590E4A cumulative extracted ownership total');
equal(summary.legacy, summary.total - 323, 'STEP590E4A cumulative legacy ownership total');
