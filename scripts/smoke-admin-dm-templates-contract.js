...
const templateDomainSource = fs.readFileSync(path.join(ROOT, 'src', 'bot', 'domains', 'adminCommunications', 'templateCallbacks.js'), 'utf8');
...
const callbacks = templateDomainSource;
