...
assert.ok(botSource.includes('• <b>Приглашено</b> — валидные joins по вашей ссылке.'), 'invite performance screen must explain invited');
assert.ok(botSource.includes('• <b>Активировано</b> — пользователи, которые дошли до completed profile.'), 'invite performance screen must explain activated');
