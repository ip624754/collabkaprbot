...
equal(summary.extracted, 285, 'STEP590E3C cumulative extracted ownership total');
equal(summary.legacy, summary.total - 285, 'STEP590E3C cumulative legacy ownership total');
