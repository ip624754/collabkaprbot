...
equal(summary.extracted, 407, 'STEP590E5B cumulative extracted ownership total');
equal(summary.legacy, summary.total - 407, 'STEP590E5B cumulative legacy ownership total');
