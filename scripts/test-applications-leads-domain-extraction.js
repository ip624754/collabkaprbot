...
equal(summary.extracted, 209, 'STEP590E2 cumulative extracted ownership total');
equal(summary.legacy, summary.total - 209, 'STEP590E2 cumulative legacy ownership total');
