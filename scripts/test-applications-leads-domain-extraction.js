...
equal(summary.extracted, 482, 'STEP590E6 cumulative extracted ownership total');
equal(summary.legacy, summary.total - 482, 'STEP590E6 cumulative legacy ownership total');
